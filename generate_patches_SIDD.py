...
parser.add_argument('--src_dir', default='../../datasets/SIDD_Small_sRGB_Only/Data', type=str, help='Directory for full resolution images')
parser.add_argument('--tar_dir', default='../../datasets/SIDD_Small_patches/train',type=str, help='Directory for image patches')
